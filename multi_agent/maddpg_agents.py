...
class Maddpg():
    ...
    def checkpoints(self, solution):
        """Save checkpoints for all Agents"""
        for idx, agent in enumerate(self.agents):
            actor_local_filename = 'output/' + str(solution) + '_checkpoint_actor_local_' + str(idx) + '.pth'
            critic_local_filename = 'output/' + str(solution) + '_checkpoint_critic_local_' + str(idx) + '.pth'           
            actor_target_filename = 'output/' + str(solution) + '_checkpoint_actor_target_' + str(idx) + '.pth'
            critic_target_filename = 'output/' + str(solution) + '_checkpoint_critic_target_' + str(idx) + '.pth'            
